...
def load_model(weights='./runs/exp50_yolov4-csp-results/weights/best_yolov4-csp-results.pt', imgsz=416, source='../datasets/scut_head_dataset_A/Fotoleti', device=''):
    ...
    return model, imgsz, half
        

def inference(model, img, half, augment=False, conf_thres=0.4, iou_thres=0.5, classes=None, agnostic_nms=False):
    t0 = time.time()
